import { RealtimeLogger } from './log/RealtimeLogger.js'

export const logger = new RealtimeLogger(process.stdout, process.stderr)
...
//   // @ts-expect-error - we don't need the full type here
//   stdout = { write() {} }
// }
